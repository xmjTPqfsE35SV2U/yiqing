  ...
  methods: {
    getTimelineService () {
      Request.get('data/getTimelineService').then((res:any) => {
        ...
        this.infoObj.push(res.data[3])
      })
    }
  },
  created () {
    this.getTimelineService()
  }
})
</script>
